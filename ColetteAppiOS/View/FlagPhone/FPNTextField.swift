...
open class FPNTextField: UITextField, FPNCountryPickerDelegate, FPNDelegate {
    ...
    private var phoneCodeTextField: InsetTextField2 = InsetTextField2()
    private lazy var countryPicker: FPNCountryPicker = FPNCountryPicker()
    private lazy var phoneUtil: NBPhoneNumberUtil = NBPhoneNumberUtil()
    private var nbPhoneNumber: NBPhoneNumber?
    private var formatter: NBAsYouTypeFormatter?
    
    private let lblArrowIcon: PaddingLabel = {
        let view = PaddingLabel(top: 0, bottom: 0, left: 1, right: 1)
        //        view.backgroundColor = .brown
        view.isUserInteractionEnabled = true
        view.textColor = UIColors.Dimmed
        view.text = 0xE96D.iconCode()
        view.textAlignment = .center
        view.font =  UIFont(name: "sallaicons", size: 16)
    ...
    open override var textColor: UIColor? {
        didSet {
            phoneCodeTextField.textColor = UIColors.Default
        }
    }
    ...
    private func setupFlagButton() {
        lblArrowIcon.accessibilityLabel = "flagButton"
    ...
    private func setupLeftView() {
        ...
        NSLayoutConstraint(item: phoneCodeTextField, attribute: .leading, relatedBy: .equal, toItem: lblArrowIcon, attribute: .trailing, multiplier: 1, constant: 0).isActive = true
    ...
    override open func rightViewRect(forBounds bounds: CGRect) -> CGRect {
        return CGRect(x: bounds.width - 30, y: 0, width: 25, height: bounds.height)
    }
    ...
    open override func leftViewRect(forBounds bounds: CGRect) -> CGRect {
        ...
        let newRect: CGRect = CGRect(x: bounds.minX, y: bounds.minY, width: 80, height: height)
